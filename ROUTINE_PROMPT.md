...
5. Cap output at the `confluence.max_signals_per_run` limit in config/runtime.json (default 3). Highest confluence score wins ties; break further ties by pattern-tag count, then analog hit rate from framework/10-statistical-patterns.md.
